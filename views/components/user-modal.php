        ...
        <div class="p-4">
            <form action="/login" method="post">
                <div class="mb-4">
                    <label for="username" class="block text-sm text-gray-600">Usuario / Correo <span class="text-red-700">*</span></label>
                    <input type="text" id="username" name="username" class="w-full px-3 py-2 login bg-[#E8F0FE] rounded-[0.65rem] bg-blue-100" placeholder="ejemplo@correo.com">
                </div>
                <div class="mb-4">
